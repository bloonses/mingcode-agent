...
echo.
echo ================================================================
echo    MINGCODE v1.0.8 - Build Installer
echo ================================================================
echo.
...
if %errorlevel% equ 0 (
    ...
    echo   Installer:  %PROJECT_DIR%\dist\MINGCODE-Setup-1.0.8.exe
    echo.
    echo   You can now distribute MINGCODE-Setup-1.0.8.exe to users.
