...
echo.
echo ================================================================
echo    MINGCODE v1.0.3 - Build Installer
echo ================================================================
echo.
...
if %errorlevel% equ 0 (
    ...
    echo   Installer:  %PROJECT_DIR%\dist\MINGCODE-Setup-1.0.3.exe
    echo.
    echo   You can now distribute MINGCODE-Setup-1.0.3.exe to users.
